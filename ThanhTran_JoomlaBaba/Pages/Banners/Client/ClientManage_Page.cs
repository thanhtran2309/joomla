...
{
    class ClientManage_Page : Common_Page
    {
        ...
        public bool IsClientExistOnTable(string title)
        {
        ...
        //Trash Banner
        public void TrashClient(string title)
        {
            SelectTitle(title);
        ...
        //Batch Banner
        public void BatchClient(string title)
        {

        }

        //Check-in Banner
        public void CheckInClient(string title)
        {
            SelectTitle(title);
        ...
        //Publish Banner
        public void PublishClient(string title)
        {
            SelectTitle(title);
        ...
        //Unpublish Banner
        public void UnpublishClient(string title)
        {
            SelectTitle(title);
        ...
        //Feature Banner
        public void FeatureClient(string title)
        {
            SelectTitle(title);
        ...
        //Unfeature Banner
        public void UnfeatureClient(string title)
        {
            SelectTitle(title);
        ...
        //Archive Banner
        public void ArchiveClient(string title)
        {
            SelectTitle(title);
        ...
        public bool IsClientPublish(string title)
        {
        ...
        public bool IsClientUnPublish(string title)
        {
            bool isBannerPublish = IsClientPublish(title);
        ...
        public bool IsClientFeature(string title)
        {
        ...
        //Check is Banner unpublish or not
        public bool IsClientUnFeature(string title)
        {
            bool isBannerFeature = IsClientFeature(title);
        ...
        //Search feature
        public void searchClient(string title, string status, string type)
        {
